...
public class MeshGenerator {
  ...
  public static void Generate(int rows, int columns, int capacity, String filename, boolean constCap)
  {
    String[] args = new String[] { Integer.toString(rows), Integer.toString(columns), Integer.toString(capacity), filename, constCap ? "-cc" : ""};
    new MeshGenerator(args).generate();
  }
