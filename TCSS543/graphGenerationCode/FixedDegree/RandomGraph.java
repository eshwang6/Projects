...
public class RandomGraph {
  ...
  public static void Generate(int vertices, int edges, int minCap, int maxCap, String filename)
  {
    String[] args = new String[] { Integer.toString(vertices), Integer.toString(edges), Integer.toString(minCap), Integer.toString(maxCap), filename};
    RandomGraph.main(args);
  }
	...
	private static void toFile(StringBuffer outString, String filename){
		try{
			...
			System.err.println("Please check file paths and restart this program.");
			System.exit(1);
		} 
	}
}
